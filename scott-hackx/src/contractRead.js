import contractAbi from './contract.json'; // Replace with the ABI of your contract
...
async function getSupplierDetails(supplierIndex) {
  try {
    ...
    // Call the getSupplier function to retrieve the Supplier struct
    const supplier = await contract.getSupplier(supplierIndex);

    // Now you can access the supplier's properties
